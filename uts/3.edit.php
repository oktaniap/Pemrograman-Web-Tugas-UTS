...
<body>
	...
	<br>
	<center><h3>MENGEDIT DATA BARANG</h3></center>
	<br><br>
	<h5>Klik pada Kolom Edit untuk Mengedit...</h5>
	<center>
	<table class="table1">
		<thead>
			<tr>
	...
	while ($row=mysqli_fetch_array($query)) {
		...
		<tr>
			...
			<td><a href="3.1.update.php?edit=1&nama=<?php echo $row[1];?>&harga=<?php echo $row[2];?>&stok=<?php echo $row[3];?>&kode=<?php echo $row[0];?>">Klik disini</a></td>
		</tr>
		<?php
	}
	echo "</tbody>
